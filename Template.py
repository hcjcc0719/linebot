    ...
    line_bot_api.reply_message(
        ...
        TemplateSendMessage(
            ...
            template=ButtonsTemplate(
                thumbnail_image_url='https://i.imgur.com/8hLzs0A.jpg',
                title='Menu',
                text='歡迎使用我打造的過年實用工具\nPlease select',
                actions=[
                    # PostbackAction(
...
def doc(line_bot_api, event):
    line_bot_api.reply_message(
        ...
        TemplateSendMessage(
            alt_text='Buttons template',
            template=ButtonsTemplate(
                thumbnail_image_url='https://i.imgur.com/ckOzMjr.jpg',
                title='Repository or transition graph?',
                text='Please select',
                actions=[
                    URIAction(
                        label='Repository',
                        uri='https://github.com/hcjcc0719/linebot'
                    ),
                    URIAction(
                        label='Transition graph',
                        uri ='https://ibb.co/Tq1w8jh',
                    ),
                    MessageAction(
                        label='回主選單',
                        text='回主選單'
...
def money(line_bot_api, event):
    line_bot_api.reply_message(
        ...
        TemplateSendMessage(
            alt_text='Buttons template',
            template=ButtonsTemplate(
                thumbnail_image_url='https://i.imgur.com/7WAcyTY.jpg',
                title='紅包規劃',
                text='Please select',
                actions=[
                    # MessageAction(
